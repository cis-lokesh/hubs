...
function ResetToDefaultButtonPlaceholder() {
  return (
    <div
    // className={styles.resetToDefaultButtonPlaceholder}
    />
  );
}
...
class Select extends React.Component {
  ...
  render() {
    return (
      <div className="form-group">
        <select
          className="wrap-drop dropdown-setting"
...
export class MaxResolutionPreferenceItem extends Component {
  ...
  render() {
    return (
      <span className="velume-img d-flex align-items-center">
        ...
        <span className="cross-icons">X</span>
        <span className="number-input">
          <input
            className="hideArrow"
            tabIndex="0"
...
class PreferenceListItem extends Component {
  ...
  render() {
    ...
    const isSelect = this.props.itemProps.prefType === PREFERENCE_LIST_ITEM_TYPE.SELECT;
    const isNumber = this.props.itemProps.prefType === PREFERENCE_LIST_ITEM_TYPE.NUMBER_WITH_RANGE;
    const isMaxResolution = this.props.itemProps.prefType === PREFERENCE_LIST_ITEM_TYPE.MAX_RESOLUTION;
    const isSmallScreen = window.innerWidth < 600;
    const label = intl.formatMessage(preferenceLabels[this.props.storeKey]);
    const hasPref =
      this.props.store.state.preferences[this.props.storeKey] !== undefined ||
    ...
    if (isCheckbox) {
      ...
      return (
        <div className="velume d-flex align-items-center">
          <h2 className="text-box-right">{label}</h2>
          <Control itemProps={this.props.itemProps} store={this.props.store} setValue={this.props.setValue} />
          {/* {resetToDefault} */}
        </div>
      );
...
const CATEGORY_GRAPHICS = 1;
const CATEGORY_MISC = 2;
const CATEGORY_MOVEMENT = 3;
const CATEGORY_TOUCHSCREEN = 4;
const TOP_LEVEL_CATEGORIES = [CATEGORY_AUDIO, CATEGORY_GRAPHICS, CATEGORY_MOVEMENT, CATEGORY_MISC];
const TOP_LEVEL_CATEGORIES_ID = ["#audio-f", "#graphics-s", "#movement-t", "#misc-f"];
const categoryNames = defineMessages({
  [CATEGORY_AUDIO]: { id: "preferences-screen.category.audio", defaultMessage: "Audio" },
  [CATEGORY_GRAPHICS]: { id: "preferences-screen.category.controls", defaultMessage: "Graphics" },
...
function NavItem({ ariaLabel, title, onClick, selected, href }) {
  return (
    <li>
      <a data-toggle="tab" href={href} aria-label={ariaLabel} onClick={onClick}>
        {title}
      </a>
    </li>
    // <button
...
class PreferencesSettingScreen extends Component {
  static propTypes = {
    intl: PropTypes.object,
  ...
  createSections() {
    ...
    const DEFINITIONS = new Map([
      ...
      [
        ...
        [
          {
            key: "maxResolution",
            prefType: PREFERENCE_LIST_ITEM_TYPE.MAX_RESOLUTION
          },
    ...
    return new Map([
      ...
      [CATEGORY_GRAPHICS, [{ items: items.get(CATEGORY_GRAPHICS) }]],
      [CATEGORY_MOVEMENT, [{ items: items.get(CATEGORY_MOVEMENT) }]],
      [CATEGORY_TOUCHSCREEN, [{ items: items.get(CATEGORY_TOUCHSCREEN) }]],
          ...
          <div className="container">
            <div className="signinUp-box-setting d-flex flex-wrap justify-content-center">
              <div className="seeting-audio">
                {/* <span className="btn-next circle-btn">
                <img src={arrowIcon} />
              </span> */}
                <span onClick={this.props.onClose} className="btn-close-setting">
                  <img src={closeIcon} className="img-close-setting" />
                </span>
                <form className="theme-form">
                  {/* <div className="form-head">
                  <h6>Settings</h6>
                  <ul className="nav nav-tabs head-tabs-sec">
                    <li>
                      <a data-toggle="tab" href="#audio-f" className="active">
                        Audio
                      </a>
                    </li>
                    <li>
                      <a data-toggle="tab" href="#graphics-s">
                        Graphics
                      </a>
                    </li>
                    <li>
                      <a data-toggle="tab" href="#movement-t">
                        Movement
                      </a>
                    </li>
                    <li>
                  ...
                  <Nav selected={this.state.category}>
                    ...
                    <NavItem
                      ...
                      selected={category === this.state.category}
                      href={TOP_LEVEL_CATEGORIES_ID[index]}
                    />
                  ))} */}
                  </Nav>
                  <div className="form-body">
                    <div className="tab-content">
                      ...
                      >
                        ...
                        <div className="tab-content">
                          <div id="levels" className="tab-pane in active">
                            {/* <div className="velume d-flex align-items-center valume-top">
                            <h2>Preferred Mic: </h2>
                            <div className="form-group">
                              <select className="wrap-drop">
                          ...
                          <div className="velume-sec">
                            ...
                            <div className="velume d-flex align-items-center">
                              <h2 className="text-box-right">Input Voice Volume:</h2>
                              <span className="velume-img">
                                <img src={menuScaleIcon} />
                              </span>
                            </div>
                            <div className="velume d-flex align-items-center">
                              <h2 className="text-box-right">Media Volume:</h2>
                              <span className="velume-img">
                                <img src={menuScaleIcon} />
                              </span>
                            </div>
                            ...
                            <div className="velume d-flex align-items-center">
                              ...
                              <h2>Disable Mic Noise Suppression</h2>
                            </div>
                            <div className="velume d-flex align-items-center">
                              <span className="velume-img">
                                <div className="form-group">
                          ...
                          <div id="input" className="tab-pane fade">
                            <div className="velume d-flex align-items-center">
                              <span className="velume-img">
                                <div className="form-group">
                                  <label className="switch-field">
                            ...
                            <div className="velume d-flex align-items-center">
                              <h2 className="text-box-right">Audio Clipping Threshold</h2>
                              <span className="velume-img">
                                <img src={menuScaleIcon} />
                              </span>
                            </div>
                      ...
                      >
                        <div className="tab-content">
                          {/* <div id="Resolution">
                          <div className="velume valume-misc d-flex align-items-center valume-top">
                            <h2 className="text-box-right">Max Resolution </h2>
                            <span className="velume-img d-flex align-items-center">
                              <span className="number-input">
                                <input type="text" name={1920} placeholder={1920} />
                              </span>
                              <span className="cross-icons">X</span>
                              <span className="number-input">
                                <input type="text" name={1920} placeholder={1920} />
                          ...
                          <div className="velume valume-misc d-flex align-items-center valume-top">
                            <h2 className="text-box-right">Preferred Camera</h2>
                            <div className="form-group">
                              <select className="wrap-drop">
                                <option>Select</option>
                                <option>Option 1</option>
                          ...
                          <div className="velume valume-misc d-flex align-items-center valume-top">
                            <h2 className="text-box-right">Material Quality</h2>
                            <div className="form-group">
                              <select className="wrap-drop">
                                <option>Select</option>
                                <option>Option 1</option>
                          ...
                          <div className="velume d-flex align-items-center">
                            ...
                            <h2>Disable Automatic Pixel Ratio Adjustments</h2>
                          </div>
                        </div> */}
                      ...
                      >
                        ...
                        <div className="tab-content">
                          <div id="mode" className="tab-pane in active">
                            {/* <div className="velume d-flex align-items-center">
                            <h2 className="text-box-right">
                              Rotation Per Snap<span>(in Degrees)</span>
                            </h2>
                            <span className="velume-img d-flex align-items-center">
                              <span className="number-input">
                          ...
                          <div className="velume d-flex align-items-center">
                            ...
                            <h2>Disable Backwards Movement</h2>
                          </div>
                          <div className="velume d-flex align-items-center">
                            <span className="velume-img">
                              <div className="form-group">
                          ...
                          <div className="velume d-flex align-items-center">
                            ...
                            <h2>Disable Teleporter</h2>
                          </div>
                          <div className="velume d-flex align-items-center">
                            <h2 className="text-box-right">Movement Speed Modifier</h2>
                            <span className="velume-img d-flex align-items-center">
                              <span className="number-input">
                                <input type="text" name placeholder={25} />
                              </span>
                          ...
                          <div id="Teleport" className="tab-pane fade">
                            <div className="velume-sec">
                              {/* <div className="velume d-flex align-items-center">
                              <span className="velume-img">
                                <div className="form-group">
                              ...
                              <h2>Enable left on-screen joystick for moving around</h2>
                            </div>
                            <div className="velume d-flex align-items-center">
                              <span className="velume-img">
                                <div className="form-group">
                              ...
                              <h2>Enable right on-screen joystick for moving around</h2>
                            </div>
                            <div className="velume d-flex align-items-center">
                              <span className="velume-img">
                                <div className="form-group">
                              ...
                              <h2>Enable Gyroscope(when supported by browser/device)</h2>
                            </div>
                            <div className="velume d-flex align-items-center">
                              <span className="velume-img">
                                <div className="form-group">
                              ...
                              <h2>Invert direction of camera movement for touchscreens</h2>
                            </div> */}
                              {this.createSections()
                                .get(4)
                                .map(Section)}
                      ...
                      >
                        ...
                        <div className="velume-sec">
                          <div className="velume d-flex align-items-center">
                            ...
                            <h2>Only show nametags when frozen</h2>
                          </div>
                          <div className="velume d-flex align-items-center">
                            <span className="velume-img">
                              <div className="form-group">
                            ...
                            <h2>Disable auto exit when multiple hubs instances are open</h2>
                          </div>
                          <div className="velume d-flex align-items-center">
                            <span className="velume-img">
                              <div className="form-group">
                            ...
                            <h2>Disable auto exit when idle or backgrounded</h2>
                          </div>
                          <div className="velume d-flex align-items-center">
                            <span className="velume-img">
                              <div className="form-group">
                            ...
                            <h2>Enable fast room switching</h2>
                          </div>
                          <div className="velume d-flex align-items-center">
                            <span className="velume-img">
                              <div className="form-group">
                            ...
                            <h2>Prefer mobile object info panel</h2>
                          </div>
                          <div className="velume d-flex align-items-center">
                            <span className="velume-img">
                              <div className="form-group">
                            ...
                            <h2>Animate Waypoint transitions</h2>
                          </div>
                          <div className="velume d-flex align-items-center">
                            <span className="velume-img">
                              <div className="form-group">
...
export default injectIntl(PreferencesSettingScreen);
